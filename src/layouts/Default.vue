    ...
    <header class="border-t-14 border-blue">
      <nav class="container mx-auto flex justify-between items-center py-8">
        ...
        <ul class="uppercase tracking-wide font-bold flex items-center">
          <li class="mr-8"><a a href="#" class="text-gray-800 hover:text-gray-600">Courses</a></li>
          <li class="mr-8"><a a href="#" class="text-gray-800 hover:text-gray-600">Youtube</a></li>
        </ul>
      </nav>
      Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellat ex voluptatibus soluta id numquam, illum dolorum omnis reprehenderit nam deleniti eaque praesentium tempora accusantium molestias sint quos sequi recusandae possimus!
    </header>
    <div class="flex-grow">
      <slot/>
    </div>
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:billyzman87@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/BillyZimmerman" target="_blank" class="text-white hover:text-gray-400">
